...
contract Lottery {
    VRFv2Consumer vrfContract; /// Instance of the VRFv2Consumer object that will be used in getRandomIndex() to obtain VRF's number.
    Payments splitFunds; /// Payments object. Payments is paymentSplitter contract.

    uint256 constant TICKET_COST = 1e16; 
